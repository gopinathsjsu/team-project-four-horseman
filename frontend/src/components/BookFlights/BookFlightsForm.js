        ...
        <div className='book-flights'>
            ...
            <form action='/displayflights' method='get'>
                ...
                <div className='trip-type'>
                    <input type='radio' name='tripType' value='oneWay' checked ></input> One-Way

                </div>
                <div className='book-flights-form'>
                <span>From</span><br/><br/>
                {airportList && <AirportList value={airportList} title='departure-airport'/>}
            </div><div className='book-flights-form'>
                <span>To</span><br/><br/>
                {airportList && <AirportList value={airportList} title='arrival-airport'/>}
            </div><div className='date-form'>
<label htmlFor='trip-start'>Departure</label><br/>
<input type="date" id="trip-start" name="trip-start" required ></input>
                </div>
                
                
            <div className='book-flights-form'>
                <span>Cabin</span><br/><br/>
